...
Карточка скважины хранит metadata проекта: рабочее название, статус, комментарий и координаты X/Y, широту и долготу. Географические координаты валидируются перед сохранением; LAS-файлы и расчетные snapshots при этом не читаются и не копируются.
