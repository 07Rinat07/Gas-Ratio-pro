...
## Печать и экспорт v225.3

- единый физический пакет A4/A3 для SVG, PDF и PNG;
- точный профиль, DPI и число страниц до экспорта;
- общие колонтитулы, нумерация и повторяемая легенда на русском, казахском и английском языках;
- page-aware preview для последующей прямой интеграции с DOCX/HTML;
- одностраничный fallback отключён.
