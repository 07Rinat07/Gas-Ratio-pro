...
- Полноширинный адаптивный Dashboard shell: фирменный фон с морской буровой используется как общий бренд-слой приложения, а рабочие области с графиками, LAS-кривыми, таблицами и отчетами закрываются темными панелями для читаемости. Главная страница использует крупные функциональные action-карточки, современный navbar, анимированные tab-кнопки, glass-виджеты и динамические данные проекта.
