...
- LAS-редактор: проверка глубины, изменение шага, добавление строк, ручная правка и передача подготовленных данных в расчеты.
...
- Постоянное хранение скважин, выгрузка исправленного LAS/XLSX, PDF/PNG/SVG отчеты и расширенная RAG/AI-база знаний планируются в следующих версиях.
