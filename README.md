...
- Project Explorer в боковой панели: дерево проекта, группы скважин, пользовательские папки, metadata-only перемещение объектов и цветовые метки для скважин, LAS-версий, расчетов и экспортов.
