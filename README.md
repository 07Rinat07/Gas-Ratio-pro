...
и предварительной rule-based интерпретации интервалов.

Проект развивается без встроенного генеративного ИИ: помощь пользователю дается
через документацию, проверяемые правила, предупреждения, логи, тесты и отчеты.
...
- LAS-корреляция: загрузка нескольких LAS, распознавание ГИС/газовых кривых и соседние depth-треки для сравнения скважин.
...
- [План проекта без встроенного ИИ](docs/project_plan.md)
