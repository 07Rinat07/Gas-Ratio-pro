...
Карточка скважины хранит metadata проекта: рабочее название, статус, комментарий, координаты X/Y, широту/долготу и отметку KB в метрах. Географические координаты и KB валидируются перед сохранением; LAS-файлы и расчетные snapshots при этом не читаются и не копируются.
