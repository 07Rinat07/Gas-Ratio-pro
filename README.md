...
- Целевой планшетный renderer по референсным рисункам находится в плане: выбор любых числовых LAS/Excel/CSV параметров, отдельные треки, авто/ручные шкалы по каждому параметру, глубина по возрастанию вниз, маркеры и таблица интерпретации под графиком.
