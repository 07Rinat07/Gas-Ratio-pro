...
- Полноширинный адаптивный Dashboard shell: фирменный Gas Ratio Pro фон и логотип используются как общий бренд-слой приложения, а рабочие области с графиками, LAS-кривыми, таблицами и отчетами закрываются темными панелями для читаемости. Главная страница использует крупные функциональные action-карточки, современный navbar, анимированные tab-кнопки, glass-виджеты и динамические данные проекта.
