...
- видимый Professional Print Center показывает точный A4/A3-профиль, DPI и число страниц до запуска;
- доступен прямой выбор и просмотр каждой физической SVG-страницы;
- DOCX/HTML получают полный page-aware preview без повторного layout;
- одностраничный fallback запрещён строгим preview-контрактом;
