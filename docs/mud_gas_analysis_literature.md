...
Минимальный безопасный срез реализации: сначала строить эти графики по уже
подготовленным расчетным данным, затем расширить mapping для ГИС-кривых и
корреляции нескольких LAS.
