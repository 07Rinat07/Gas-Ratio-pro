...
Минимальный безопасный срез реализации: сначала строить планшет по уже
подготовленным расчетным данным и сохраненным LAS/Excel-наборам, затем расширить
mapping для ГИС-кривых и корреляции нескольких LAS.
