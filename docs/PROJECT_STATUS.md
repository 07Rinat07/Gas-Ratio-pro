...
Исправляется подтвержденный по пользовательским скриншотам дефект: легенды и служебные подписи перекрывали названия графиков. Экспортный кэш принудительно версионирован номером сборки, чтобы изменения печатной компоновки сразу попадали в новые документы.

### v222.62
Завершено устранение пересечений подписей и масштабирование детальных планшетов для печати.

### v222.60 — Track Layout Engine Foundation

- Статус: завершено.
- Реализованы адаптивные относительные ширины треков.
- Добавлены экранный и печатный layout-профили.
- Заголовки дорожек масштабируются по плотности планшета.
- Следующий шаг: группировка слишком плотных планшетов и пользовательские шаблоны раскладки.
