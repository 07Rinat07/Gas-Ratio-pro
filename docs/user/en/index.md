# GAS RATIO PRO User Documentation

Current instructions for using the application. Documents are synchronized across Russian, Kazakh, and English.
...
- [Print Center and physical pages](print_center_page_aware.md) — revision 2
