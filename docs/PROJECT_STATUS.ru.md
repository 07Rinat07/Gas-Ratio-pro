...
Stable v225.8 Live Workbench Acceptance остаётся обязательным и проходит **14/14** проверок. Architecture boundaries, controlled visual baselines, full-frame report layout и numerical/calibration/authorization gates остаются блокирующими.
