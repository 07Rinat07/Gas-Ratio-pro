# v223.6 - Composite Report Readability Fix

- увеличены заголовки треков, шкалы глубины, подписи интервалов и статистика;
- интервалы перенесены в отдельные карточки глубинного трека и больше не перекрывают кривые;
- нижняя статистика min/avg/max оформлена как читаемая таблица;
- уменьшена общая ширина SVG, чтобы шрифт не сжимался до микроскопического при печати;
- удалена служебная фраза о векторном движке и Composite Log v4 из PDF/DOCX;
- отчётные заголовки заменены на нейтральные инженерные формулировки.
