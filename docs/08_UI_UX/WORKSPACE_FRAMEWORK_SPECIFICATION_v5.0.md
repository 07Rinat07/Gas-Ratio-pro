...
## Workspace Data Management Toolbar

Во всех рабочих пространствах таблицы и архивы должны иметь одинаковую панель действий:

- удалить выбранные записи;
- очистить таблицу полностью;
- обновить представление;
- физически удалить связанные файлы persistent storage;
- очистить зависимые session state ключи;
- выполнить rerun после изменения данных.

Первичная реализация подключена к таблицам сохраненных экспортов проекта и LAS-версий проекта.
