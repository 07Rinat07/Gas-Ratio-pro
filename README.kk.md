...
## Басып шығару және экспорт v225.3

- SVG/PDF/PNG үшін бірыңғай page-aware пакет;
- нақты A4/A3 профилі, бағдар, DPI және бет саны;
- физикалық колонтитулдар, бет нөмірлеуі және қайталанатын шартты белгілер;
